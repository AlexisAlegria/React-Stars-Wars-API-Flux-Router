			...
			<div>
				<div className="d-flex justify-content-center">
					<ul className="list-group" width="400px">
						...
						<li className="list-group-item">
							Hair color: {store.peopleList[parseInt(params.id)].hair_color}
						</li>
						<li className="list-group-item">
							Skin color: {store.peopleList[parseInt(params.id)].skin_color}
						</li>
						<li className="list-group-item">
							Eye color: {store.peopleList[parseInt(params.id)].eye_color}
						</li>
						<li className="list-group-item">
							Birth Year: {store.peopleList[parseInt(params.id)].birth_year}
						</li>
						<li className="list-group-item">Gender: {store.peopleList[parseInt(params.id)].gender}</li>
					</ul>
				</div>
			</div>
		</div>
